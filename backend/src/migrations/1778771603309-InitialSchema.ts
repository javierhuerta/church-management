...
export class InitialSchema1778771603309 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('Pastor', 'Anciano', 'CoordinadorMisionero', 'DirectorDepartamento', 'Secretaria', 'MaestroClase')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."events_eventtype_enum" AS ENUM('CultoSabatico', 'EscuelaSabatica', 'CultoVespertino', 'SemanaOracion', 'EventoMisional', 'JuntaAdministracion', 'Otro')`);
