...
El sistema SHALL impedir la eliminación de una Persona que esté referenciada por un estudio bíblico, ya sea como estudiante o como instructora.

Las demás capacidades que referencien Personas SHALL agregar sus propias reglas de bloqueo en su spec.
...
El detalle de una Persona SHALL incluir el listado de los estudios bíblicos en los que figura como estudiante, con su curso, estado y progreso.
