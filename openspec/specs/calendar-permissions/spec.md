...
Define which roles can view, create, edit, delete, and change status of calendar events. Editor roles (Pastor, Secretaria de Iglesia, Admin) have full write access; all other users (including anonymous) have read-only access to published events.
