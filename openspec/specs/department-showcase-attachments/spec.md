# Department Showcase Attachments

## Purpose

Manage file attachments for department showcases, allowing directors to upload documents, images, and PDFs to complement their showcase content.
