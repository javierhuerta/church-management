# Event Attachments — File Uploads and Gallery

## Purpose

Allow editors to attach files (images, documents, videos) to events. Attachments are displayed in a gallery on the event detail page. One image can be designated as the event cover.
