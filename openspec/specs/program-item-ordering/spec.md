# Program Item Ordering

## Purpose

Defines the drag & drop interactions for reordering groups and sections within a worship service program detail view. Reordering is only available to users with edit permissions.
