...
The system SHALL provide a login page where users can authenticate with their email and password credentials. The login page SHALL use semantic design tokens compatible with the active theme.
