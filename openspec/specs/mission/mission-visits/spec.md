...
Cada visita vincula una Persona visitada con un estado obligatorio (`Sin comenzar`, `En curso`, `Completado`, `Cancelado`) y, opcionalmente, una fecha planificada, una fecha de realización, un responsable y el resultado de la visita.

#### Scenario: Registrar una visita planificada
- **WHEN** un coordinador misionero registra una visita a una Persona con estado `Sin comenzar` y una fecha planificada
- **THEN** el sistema registra la visita

#### Scenario: Registrar una visita completada
- **WHEN** un coordinador misionero registra una visita con estado `Completado`, fecha de realización y resultado
...
- **WHEN** un coordinador misionero cambia una visita de `Sin comenzar` a `Completado` y registra su resultado
...
- **WHEN** un usuario filtra las visitas por el estado `Sin comenzar`
- **THEN** el sistema devuelve únicamente las visitas en ese estado