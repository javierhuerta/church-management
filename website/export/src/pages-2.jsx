...
function PageHorarios() {
  const week = [
    { d: 'Sábado', accent: true, items: [
      ['09:30', 'Escuela Sabática', 'Estudio bíblico por grupos. Para niños, jóvenes y adultos.'],
      ['11:00', 'Culto Divino', 'Adoración con cantos, oración y predicación. Transmisión en vivo.'],
    ]},
    { d: 'Miércoles', items: [
      ['19:30', 'Reunión de Oración', 'Estudio breve y oración en el templo.'],
    ]},
    { d: 'Viernes', items: [
      ['19:30', 'Bienvenida del Sábado', 'Cantos y devocional al abrir el sábado.'],
    ]},
  ];
