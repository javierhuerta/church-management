          ...
          <div className="hero-grid" style={{
            ...
            <div>
              <div style={{
                ...
                <img src={(window.__resources && window.__resources.logo) || "assets/logo.png"} alt="" style={{
              ...
              <div style={{
                ...
                <MiniInfo label="Sábados"   value="09:30" sub="Escuela Sabática" gold />
                <MiniInfo label="Sábados"   value="11:00" sub="Culto Divino" gold />
              </div>
            </div>
      ...
      <section className="section-tight" style={{ paddingTop: 0 }}>
        <div className="container">
          <div style={{
            ...
            {[
              ['Sábado',    '09:30', 'Escuela Sabática y Culto Divino'],
              ['Miércoles', '19:30', 'Reunión de Oración'],
              ['Viernes',   '19:30', 'Bienvenida del Sábado'],
            ].map(([d, h, t], i) => (
              <div key={d} style={{
                padding: '32px 28px',
